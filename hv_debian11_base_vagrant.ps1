...
if ($Ready -ne $false) {
  ...
  # Variables
  $template_file="$PSScriptRoot\templates\hv_debian11_base_g2_vagrant.pkr.hcl"
  $var_file="$PSScriptRoot\variables\variables_debian11_base.pkrvars.hcl"
  $machine="debian11.0.0"
  $packer_log=0
