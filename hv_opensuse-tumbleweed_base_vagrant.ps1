...
if ($Ready -ne $false) {
  ...
  # Variables
  $template_file="$PSScriptRoot\templates\hv_opensuse-tumbleweed_base_g2_vagrant.pkr.hcl"
  $var_file="$PSScriptRoot\variables\variables_opensuse-tumbleweed.pkrvars.hcl"
  $machine="opensuse-tumbleweed"
  $packer_log=0
