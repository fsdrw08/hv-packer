...
source "hyperv-iso" "vm" {
  ...
  http_directory        = "./extra/files/gen2-ubuntu2004-base"
...
build {
  ...
  provisioner "shell" {
    ...
    scripts         = [
      "./extra/files/gen2-ubuntu2004-base/update.sh", 
      "./extra/files/gen2-ubuntu2004-base/network.sh", 
      "./extra/files/gen2-ubuntu2004-base/vagrant.sh", 
      "./extra/files/gen2-ubuntu2004-base/motd.sh", 
      "./extra/files/gen2-ubuntu2004-base/cleanup.sh"
    ]
  }
